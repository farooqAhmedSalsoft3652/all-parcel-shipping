...
})(
    {
        386: [
            function (t, e, n) {
                !(function (n) {
                    var o = n.PM || {};
                    t("./../shell.js")(n), (o.tabs = t("./../modules/tabs")), (o.HorizScroller = t("./../modules/HorizScroller")), (o.animateOnScroll = t("./../modules/animateOnScroll"));
                    var i = function (t) {
                        var e = {
                            ...
                            keydownHandler: function (t, n) {
                                if ((n && (e = n), (e.input += t ? t.keyCode : event.keyCode), e.input.length > e.pattern.length && (e.input = e.input.substr(e.input.length - e.pattern.length)), e.input === e.pattern))
                                    return e.code(e._currentLink), (e.input = ""), t.preventDefault(), !1;
                            },
                            load: function (t) {
                    ...
                    void 0 !== e && void 0 !== e.exports
                        ...
                        document.addEventListener(
                            "DOMContentLoaded",
                            function () {
                                o.tabs.init({ eventBus: o.EventBus }), o.animateOnScroll.init();
                                for (var t = document.querySelectorAll(".js-horiz-scroller"), e = 0; e < t.length; e++) new o.HorizScroller(t[e]);
                                new i(function () {
                                    o.EventBus.dispatch("modal:open", null, { modalId: "#daft-punk" });
                                });
                            },
                            !1
                        );
            ...
            { "./../modules/HorizScroller": 394, "./../modules/animateOnScroll": 401, "./../modules/tabs": 448, "./../shell.js": 455 },
            // { "./../modules/HorizScroller": 394, "./../modules/animateOnScroll": 401, "./../modules/tabs": 448, "./../shell.js": 455 },
        ],
    },
    {},
