...
const AdminAdSubscription = () => {
  usePageTitle("Ad Subscription");
  ...
  const loadAds = async () => {
    setLoad(true);
    let url = `/ad-management?page=${currentPage}`;
  ...
  const handleChange2 = async () => {
    ...
    let data = await axios.post(`ad-management/${id}/update/status`, {
      status: active
    })
    .then(response => {
      if(active === 1){
  ...
  const handleClickSubscription = () => {
    navigate("/admin/ad-subscription/add-subscription");
  };
                                ...
                                <tr key={index}>
                                  ...
                                  <td>
                                    <div className="d-flex align-items-center">
                                      ...
                                      <Link
                                        to={`/admin/ad-subscription/detail/${item.id}`}
                                      ...
                                      <Link
                                        to={`/admin/ad-subscription/edit-subscription/${item.id}`}
                                        className="tableAction"
                                      >
                                        <FontAwesomeIcon
...
export default AdminAdSubscription;
