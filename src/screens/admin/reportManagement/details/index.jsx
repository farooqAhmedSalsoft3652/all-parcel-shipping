...
const ReportDetail = () => {
  ...
  useEffect(() => {
    const filteredData = reportApiData.find((item) => id == item.id);
            ...
            <div className="bg-white rounded-10 shadow-sm p-5 p-lg-5 p-xxl-5">
              <div class="mainTitle mb-0 mb-4 mb-lg-5">
                <div className="d-flex align-items-center gap-2 ">
                  <BackButton />
                  <h2 className="text-black fw-medium">Report Details</h2>
                </div>
              </div>
              <Row>
                <Col xl={11}>
                  <div className="detail-block feedback">
                    <div className="feedback-header d-xl-flex justify-content-between px-5 py-4">
                      <h3 className="fw-medium text-white mb-2 mb-xl-0">Feedback Information</h3>
                      <h3 className="fw-medium text-white mb-0">Report Order Number: #{detailData.orderNo}</h3>
                    </div>
                    <div className="feedback-body px-5 py-5">
                      <Row>
                        ...
                        <Col xs={12} md={6} xl={4} className="mb-4 mb-md-4 mb-xxl-5">
                          <h5 className="fw-medium mb-1 mb-md-2">Last Name</h5>
                          <p className="">
                            {detailData.lastName}
                          </p>
                        </Col>
                      ...
                      <Row>
                        <Col xs={12} lg={10} xl={8} xxl={6} className="">
